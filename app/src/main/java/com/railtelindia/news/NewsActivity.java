...
public class NewsActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        ...
        String sources = sharedPrefs.getString(
                getString(R.string.settings_sources_key),
        ...
        uriBuilder.appendQueryParameter("source", sources);
        uriBuilder.appendQueryParameter("sortBy", orderBy);
        uriBuilder.appendQueryParameter("apiKey", "85a90e883c17491ebba939fbc1618f19");
